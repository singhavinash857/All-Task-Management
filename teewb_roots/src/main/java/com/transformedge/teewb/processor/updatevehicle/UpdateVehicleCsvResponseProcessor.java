 ...
 */
@Component
public class UpdateVehicleCsvResponseProcessor implements Processor {
    ...
    public void process(Exchange exchange) throws Exception {
        ...
        logger.info("Processing update response for invoice: " + processedInvoice.getFieldValue("e_trx_id"));
        CancelCsvOutputData.CsvOutputRow row = csvOutputData.newRow();
        if ( (cancelOutputResponse.getColumnValue("validUpto")!= null)
                && (cancelOutputResponse.getColumnValue("vehUpdDate")!= null)
                ) {
            ...
            row.addColumn("g_valip_upto", cancelOutputResponse.getColumnValue("validUpto"));
            row.addColumn("g_vehicle_update_date", cancelOutputResponse.getColumnValue("vehUpdDate"));
            ...
            row.addColumn("e_doc_num", processedInvoice.getFieldValue("e_doc_num"));
            row.addColumn("e_doc_type", processedInvoice.getFieldValue("e_doc_type"));
            row.addColumn("g_valip_upto", "");
            row.addColumn("g_vehicle_update_date", "");
